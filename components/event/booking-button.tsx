...
export function BookingButton({ eventId, price, hasAuth }: BookingButtonProps) {
    ...
    return (
        <Button
            ...
            disabled={isLoading}
            className="w-full h-12 text-base bg-moss-600 hover:bg-moss-700 shadow-md transition-all"
        >
            {isLoading ? (
                <>
