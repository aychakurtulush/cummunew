...
export default async function HostDashboardPage() {
    ...
    // Calculate stats
    const totalRevenue = 0; // Placeholder until payments
        ...
        <div className="space-y-8">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-stone-500">Welcome back, {user.email?.split('@')[0] || 'Host'}.</p>
                </div>
                            ...
                            {pendingBookings.map((booking: any) => (
                                <div key={booking.id} className="flex items-center justify-between p-4 bg-moss-50/30">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Badge className="bg-amber-100 text-amber-800 hover:bg-amber-200 border-amber-200">Pending</Badge>
                                        <Button size="sm" variant="outline" className="border-moss-200 hover:bg-moss-50 hover:text-moss-700">
                                            Review
                                        </Button>
                                    </div>
                                </div>
            ...
            {/* Upcoming Events List (Fallback to existing logic if needed, or simplified) */}
            <div>
