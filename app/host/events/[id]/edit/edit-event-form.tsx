                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-2">
                            ...
                            <select
                                ...
                                defaultValue={event.difficulty_level || "all"}
                                className="flex h-10 w-full rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-moss-600/20"
                            >
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                id="age_range"
                                name="age_range"
                                defaultValue={event.age_range || "all"}
                                className="flex h-10 w-full rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-moss-600/20"
                            >
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="languages"
                                name="languages"
                                defaultValue={event.languages?.join(', ')}
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input id="price" name="price" type="number" min="0" step="0.01" required value={price} onChange={e => setPrice(e.target.value)} />
                        </div>
                        <div className="space-y-2">
